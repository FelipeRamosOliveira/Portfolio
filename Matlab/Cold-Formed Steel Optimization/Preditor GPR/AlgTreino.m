function [trainedModel, validationRMSE] = AlgTreino(trainingData)
...
% Auto-generated by MATLAB on 31-Aug-2019 16:09:59
...
inputTable = array2table(trainingData, 'VariableNames', {'t', 'bf', 'bs', 'bw', 'Py', 'Pl', 'Pg', 'Pd'});

predictorNames = {'t', 'bf', 'bs', 'bw', 'Py'};
predictors = inputTable(:, predictorNames);
response = inputTable.Pd;
